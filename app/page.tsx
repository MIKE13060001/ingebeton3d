...
export default function Home() {
  return (
    <main className="bg-[#FAFAFA] dark:bg-[#000] transition-colors duration-500">
      ...
      <section className="min-h-screen bg-[#F5F5F5] dark:bg-black text-black dark:text-white px-16 py-32 border-t border-black/5 dark:border-white/10 flex flex-col justify-center transition-colors duration-500">
      ...
      <section className="min-h-screen bg-white dark:bg-[#111] text-black dark:text-white px-16 py-32 flex items-center transition-colors duration-500">
        <div className="w-1/2 pr-16">
          <h2 className="text-5xl font-light mb-8 tracking-tight">
            Une expertise reconnue depuis plus de 15 ans
          </h2>
          <p className="text-black/60 dark:text-white/60 font-light text-lg mb-8 leading-relaxed max-w-xl">
          ...
          <div className="grid grid-cols-2 gap-12 mt-12">
            <div>
              ...
              <div className="text-sm tracking-widest uppercase text-black/40 dark:text-white/40">Projets livrés</div>
            </div>
            <div>
              <div className="text-5xl font-light text-[#E31E24] mb-2">100%</div>
              <div className="text-sm tracking-widest uppercase text-black/40 dark:text-white/40">Satisfaction client</div>
            </div>
          </div>
        </div>
        <div className="w-1/2 h-[600px] bg-black/5 dark:bg-white/5 rounded-2xl flex items-center justify-center border border-black/10 dark:border-white/10">
          <span className="text-black/20 dark:text-white/20 font-light">[ Espace Photo / Image de réalisation ]</span>
        </div>
      </section>

      {/* Dummy Footer */}
      <footer className="bg-[#F5F5F5] dark:bg-black py-16 px-16 border-t border-black/10 dark:border-white/10 text-center transition-colors duration-500">
        <h2 className="text-3xl font-light text-black dark:text-white tracking-tight mb-2">Ingébéton</h2>
        <p className="text-sm text-black/40 dark:text-white/40 font-light">Bureau d'études structure</p>
      </footer>
    </main>
  )
}
